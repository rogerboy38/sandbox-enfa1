...
<div class="col-md-12 mt">
    ...
    <div class="content-panel" >
        <div class="row">
            <div class="col-lg-5"><h4>Metodos de Pago </h4> <br> Para poder continuar con tu mandado es necesario capturar una tarjeta de credito o debito, para futuros servicios; si no registras tu tarjeta no podremos atender tu mandado </div>
                    ...
                    <form action="{{route('userpayments')}}" method="POST" id="payment-form" class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-6">
                                ...
                                <input type="text" size="20" data-stripe="number" class="form-control" placeholder="Numero de Tarjeta" name="number" />
                                <br>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12" >
                            <span class="col-lg-3"><br>
                                <button id="payment" type="submit" class="btn btn-success">Guardar Tarjeta</button>
                            </span>
                        </div>
            ...
            <?php if ($payments) { ?>
                ...
                <div class="col-lg-12" style="padding-left:20px;">
                    <div class="col-lg-3" style="padding:10px">
                        <img src="{{ asset_url() }}/web/credit_card.png">&nbsp;&nbsp;&nbsp;Tarjeta
                    </div>
                    <div class="col-lg-3" style="padding:10px;padding-top:15px;">
                        **** {{ $payment->last_four }}
                    </div>
                    <div class="col-lg-3" style="padding:10px;padding-top:15px;">
                        <a href="{{route('/user/payment/delete',$payment->id)}}">Borrar</a>
                    </div>
                </div>
                @endforeach
            <?php } ?>
            ...
            <div class="col-lg-12" style="padding:20px;">
                <h4>Personaliza tu c&oacute;digo de Referido</h4><br>
                <div class="col-lg-6" >
                    <form method="post" action="{{route('/user/update_code')}}">
                        ...
                        <div class="col-lg-2"  style="padding-top:10px;text-align:right;">
                            <button type="submit" class="btn btn-theme">Cambiar C&oacute;digo</button>
                        </div>
                    </form>
                </div>
            </div>-->
