...
<html lang="en">
    <head>
        ...
        if(isset($_GET['optin-name'])) {
            $nameU = $_GET['optin-name'];
        } else {
            $nameU = '';
        }
    ...
    <body>
        ...
        *********************************************************************************************************************************************************** -->
        ...
        <div id="login-page">
            <div class="container">
                <a href="/" class="col-md-2 col-xs-12"><img class="imghome" src="http://enfadelivery.com/images/ICON-Enfadelivery-Transport-256.png" alt="" style="width: 60%"></a>
                <form class="form-login" action="user/saveFB" method="post">
                    <h2 class="form-login-heading">Registro</h2>
                    <div class="login-wrap">
                        <?php
                        if($nameU!='')
                        {
                            echo '<input type="text" name="first_name" value="'.$nameU.'" required class="form-control" placeholder="Nombre(s)" autofocus><br>';
                        }
                        else
                        {
                            echo '<input type="text" name="first_name" required class="form-control" placeholder="Nombre(s)" autofocus><br>';
                        }
                        ?>
                        <input type="text" name="last_name" required class="form-control" placeholder="Apellido(s)" ><br>

                        <span id="no_mobile_error1" style="display: none"> </span>
                        <?php
                        if($telU!='')
                        {
                            echo '<input type="text" name="phone" class="form-control" value="'.$telU.'" placeholder="Celular" onkeypress="return Ismobile(event, 1);"><br>';
                        }
                        else
                        {
                            echo '<input type="text" name="phone" class="form-control" placeholder="Celular" onkeypress="return Ismobile(event, 1);"><br>';
                        }
                        if($mandado!='')
                        {
                            echo '<input type="text" name="mandado" placeholder="¿Qué hacemos por ti?" class="form-control" value="'.$mandado.'"  ><br>';
                        }
                        else
                        {
                            echo '<input type="text" placeholder="¿Qué hacemos por ti?" name="mandado" class="form-control"  ><br>';
                        }
                        
                        if($dirB!='')
                        {
                            echo '<input type="text" placeholder="¿A donde te lo llevamos?" name="dirB" class="form-control" value="'.$dirB.'"  ><br>';
                        }
                        else
                        {
                            echo '<input type="text" placeholder="¿A donde te lo llevamos?" name="dirB" class="form-control"  ><br>';
                        }
                        ?>
                        <!--<input type="text" name="phone" class="form-control" placeholder="Celular" onkeypress="return Ismobile(event, 1);"><br>
-->
...
<!--<input type="text" name="email" required class="form-control" placeholder="Email Address" >-->
                        ...
                        if($emailU!='')
                        {
                            echo '<input type="text" name="email" class="form-control" value="'.$emailU.'" placeholder="Email" onblur="ValidateEmail(1)" id="email_check1" required="" >';
                        }
                        else
                        {
                            echo '<input type="text" name="email" class="form-control" placeholder="Email" onblur="ValidateEmail(1)" id="email_check1" required="" >';
                        }
                        ?>
                        
                        <br>
                        <input type="password" name="password" required class="form-control" placeholder="Contraseña"><br>
                        <select class="form-control" name="timezone"> <!-- id="timezone" -->
                            ...
                            <option value="America/Mexico_City"  selected="selected">(UTC-06:00) Mexico City</option>
                        ...
                        <br>
                        <input type="text" name="referral_code" value="Enfadelivery-Transport-60" class="form-control" placeholder="C&oacute;digo de Referido" >
                        <br>
                        ...
                        <button id="register" class="btn btn-theme btn-block" type="submit"><i class="fa fa-lock"></i> Registrar</button>
                       ...
                       <!-- <div class="registration">
                            ¿Ya tienes cuenta con nosotros?<br/>
                            <a class="" href="/usuarios/entrar">
