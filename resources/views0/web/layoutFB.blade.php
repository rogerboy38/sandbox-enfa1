                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                       ...
                       <!-- <li class="mt">
                            <a id="trips" href="{{route('/user/trips')}}">
                                <i class="fa fa-car"></i>
                                <span>Mis {{trans('customize.Trip')}}s</span>
                            </a>
                        </li>
                        <li class="">
                        ...
                        <li class="">
                            <a id="payment" href="{{route('userPaymentFB')}}">
                        ...
                        <!--<li class="" id="flow1">
                            ...
                            <a id="request" href="{{route('userrequestTrip')}}">
                                ...
                                <span>Solicitar {{trans('customize.Trip')}}</span>
                            </a>
                        </li>-->
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    <!--<h3><i class="fa fa-angle-right"></i> {{ $title }}</h3>-->
                      <h3><i class="fa fa-angle-right"></i>Gracias por registrarte en Enfadelivery-Transport-!!!</h3>
                    <div class="row mt">
                        <div class="col-lg-12">
                            @yield('content')
                        </div>
                            ...
                            if (data != '') {
                                ...
                                if (parseInt(data) != parseInt(current_state)) {
                                    ...
                                    if (data == 1) {
                                        ...
                                        if (data == 2) {
                                            title = "{{trans('customize.Provider')}} ha empezado";
                                            message = "Tu {{trans('customize.Provider')}} empezado. Preparate para el {{trans('customize.Trip')}}.";

                                        }
                                        else if (data == 3) {

                                            title = "{{trans('customize.Provider')}} ha llegado";
                                            message = "Tu {{trans('customize.Provider')}} ha llegado al punto A.";
                                        }
                                        else if (data == 4) {

                                            title = "{{trans('customize.Trip')}} ha empezado";
                                            message = "Tu {{trans('customize.Trip')}} ha empezado. Por favor no olvides calificar {{trans('customize.Provider')}} una vez que el {{trans('customize.Trip')}} este completado.";
                                        }
                                        else {
                                            title = "No  {{trans('customize.Provider')}} encontrado";
                                            message = "No {{trans('customize.Provider')}} disponible para atender {{trans('customize.Trip')}}. Por favor intentalo mas tarde.";
