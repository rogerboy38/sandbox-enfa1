                ...
                <div id="sidebar"  class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <?php if (Session::get('is_approved') == 1) { ?>
                            <p  class="centered"><a href="{{ URL::Route('providerDocuments') }}"><span class="label label-success">Aprobado</span></a></p>
                        <?php } else { ?>
                            <p  class="centered"><a href="{{ URL::Route('providerDocuments') }}"><span class="label label-danger">Sin Aprob&aacute;r</span></a></p>
                        <?php } ?>
                        ...
                        <li class="">
                            ...
                            <a href="{{ URL::Route('providerTripInProgress') }}">
                                ...
                                <span>{{trans('customize.Trip')}}s Activos</span>
                            </a>
                        </li>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Nuevo {{trans('customize.Trip')}}</h4>
                    </div>
                    <div class="modal-body">
                        <p>Tienes un nuevo {{trans('customize.Trip')}}. Por favor responde rapidamente&hellip;</p>
                        ...
                        <div style="position:relative;float:left;left:20px;">
                            ...
                            <i>Calificaci&oacute;n - </i><b id="owner-rating"> 3 </b><b>/ 5</b>
                    ...
                    <div class="modal-footer">
                        <a href="" id="accept-url"><button type="button" id="flow23" class="btn btn-success">Aceptar</button></a>
                        <a href="" id="decline-url"><button type="button" class="btn btn-danger">Rechazar</button></a>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
        </div><!-- /.modal -->
