    ...
    <div class="content-panel">
        <div class="row">
            ...
            <div class="col-md-11">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="my_address" id="my-address" placeholder="Captura la direccion de origen" style="margin-bottom:10px;width:65%;float:left;" onblur="codeAddress(1);">
                    ...
                    <div class="col-md-6" id='destination' >
                        <input type="text" class="form-control" name="my_address" id="my-dest"  placeholder="Captura la direccion de destino" style="margin-bottom:10px;width:65%;float:left;" onblur="codeAddress(2);">
