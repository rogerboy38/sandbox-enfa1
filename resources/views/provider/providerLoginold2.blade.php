        ...
        *********************************************************************************************************************************************************** -->
        ...
        <div id="login-page">
            <div class="container">
                ...
                <a href="<?php echo web_url(); ?>" class="col-md-2 col-xs-12"><img class="imghome" src="http://enfadelivery.com/images/ICON-Enfadelivery-Transport-256.png" alt="" style="width: 60%; padding-top:20px;"></a>
                {{  Form::hidden('url',URL::previous())  }}
                <form class="form-login" action="{{ URL::Route('ProviderVerify') }}" method="post">
                    {{csrf_field()}}
                    <h2 class="form-login-heading">Inicia Sesi&oacute;n ProviderLogin</h2>
...
<!--<input type="text" name="email" class="form-control" value=""  placeholder="Email Address" autofocus>-->
        ...
        <script>
                                        $.backstretch("<?php echo asset_url(); ?>/web/images/Enfadelivery-Transport-er-background-gauss.png", {speed: 500});
        </script>
