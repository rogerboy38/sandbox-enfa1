    ...
    <div class="form-panel">
        ...
        <form class="form-inline" role="form" method="get" action="{{ URL::Route('providerTrips') }}">
            ...
            <div class="form-group">
                <label class="sr-only" for="exampleInputEmail2">Fecha de Inicio</label>
                <input type="text" class="form-control" id="start-date" name="start_date" value="{{ Input::get('start_date') }}" placeholder="Start Date">
            </div>
            <div class="form-group">
                <label class="sr-only" for="exampleInputPassword2">Fecha Final</label>
                <input type="text" class="form-control" id="end-date" name="end_date" placeholder="End Date"  value="{{ Input::get('end_date') }}">
            </div>
            <button id="filter" type="submit" name="submit" value="filter" class="btn btn-theme"><i class="fa fa-filter fa-x"></i> Filtrar Resultados</button>
            <button id="download" type="submit" name="submit" value="export" class="btn btn-theme"><i class="fa fa-download fa-x"></i> Descargar Reporte</button>
