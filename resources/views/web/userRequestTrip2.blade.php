    ...
    $(document).ready(function () {
        ...
        $('#request-form').submit(function () {
            ...
            try{
                ...
                $payments = \Enfa\Payment::where('owner_id', $owner_id)->get();
...
<script type="text/javascript">
    function SaveFav(){
        ...
        if((textOrigen.value)!='')
        {
            ...
            if (alias != null) {
                ...
                $.ajax({
                    type: "POST",
                    url: "http://Enfadelivery-Transport-delivery.com/doFavoritos2.php",
                    data: {idOwner:owner, address: textOrigen.value,alias:alias},
                    cache: false,
    ...
    if (r == true) {
        ...
        $.ajax({
            type: "POST",
            url: "http://Enfadelivery-Transport-delivery.com/doFavoritos.php",
            data: {idOwner:owner, address: address,borrar:borrar},
            cache: false,
            success: function(data) {
// alert(dataString);
                alert(data);
...
<script>
    ...
    function initialize_map(lat, lng) {
        ...
        var marker_icon = '<?php echo public_path() . "/web/images/pin_driver-1.png"; ?>';
