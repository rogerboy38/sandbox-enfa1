...
<html lang="es" class="no-js">
    ...
    window.location.assign("http://localhost/enfadelivery/public/landing")
                                    ...
                                    <div class="col-md-6 hidden-sm hidden-xs">
                                        <div id="carousel-slider" class="carousel slide" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
												...
												<div class="item active">
                                                    <img src="<?php echo asset_url(); ?>/website/img/slide3.png" alt="..." class="img-responsive">
                                                </div>
                                                <div class="item">
                                                    <img src="<?php echo asset_url(); ?>/website/img/slide4.png" alt="..." class="img-responsive">
                                                </div>
												<div class="item">
                                                    <img src="<?php echo asset_url(); ?>/website/img/slide5.png" alt="..." class="img-responsive">
                                                </div>
                                            </div>
            ...
            <section id="signup">
                <div class="container">
                    ...
                    <div class="row text-center">
                        <a href="<?php echo web_url(); ?>/user/signin" class="btn btn-sign-up">COUSTOMER</a>
                        <a href="<?php echo web_url(); ?>/provider/signin" class="btn btn-sign-up">COURIER</a>
                    </div>
