...
<html>
    <head>
        ...
        <title>Tu solicitud ha sido aceptada por un Enfadelivery-Transport-er</title>
            ...
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="{{ web_url() }}" style="color:#ffffff; outline:none; text-decoration:none;">Prep&aacute;rate para el env&iacute;o</a></span>
                    </td>
                </tr>
                <!-- <tr>
                        ...
                        <table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:left;">Hola, <strong style="font-weight: bold;">{{ $mail_body['client_name'] }}</strong>,
                                        <br>
                                        El siguiente Enfadelivery-Transport-er est&aacute; listo para hacer tu servicio.
                                    </div>
                                    <!--<br><br>
                        ...
                        <table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="20%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 5px 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;">
                                        <strong style="font-weight: bold;"><?php echo 'Nombre del Enfadelivery-Transport-er'; /* echo $email_data['password']; */ ?></strong> 
                                    </div>
                                    <!--<br><br>
                                    <div style="text-align:center"><a href="#" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #ff9d3d;color:#fff;text-align:center;  text-decoration: none;">Follow</a></div>-->
                                </td>
                            ...
                            <tr>
                                <td width="20%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 5px 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;">
                                        <strong style="font-weight: bold;"><?php echo 'N&uacute;mero de Contacto'; /* echo $email_data['password']; */ ?></strong> 
                                    </div>
                                    <!--<br><br>
                                    <div style="text-align:center"><a href="#" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #ff9d3d;color:#fff;text-align:center;  text-decoration: none;">Follow</a></div>-->
                                </td>
                            ...
                            <tr>
                                <td width="20%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 5px 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;">
                                        <strong style="font-weight: bold;"><?php echo 'Modelo Motocicleta o e-Bike'; /* echo $email_data['password']; */ ?></strong> 
                                    </div>
                                    <!--<br><br>
                                    <div style="text-align:center"><a href="#" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #ff9d3d;color:#fff;text-align:center;  text-decoration: none;">Follow</a></div>-->
                                </td>
                            ...
                            <tr>
                                <td width="20%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 5px 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;">
                                        <strong style="font-weight: bold;"><?php echo 'Número de Placas'; /* echo $email_data['password']; */ ?></strong> 
                                    </div>
                                    <!--<br><br>
                                    <div style="text-align:center"><a href="#" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #ff9d3d;color:#fff;text-align:center;  text-decoration: none;">Follow</a></div>-->
                                </td>
                ...
                <tr>
                    <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                        ...
                        <div style="padding: 30px 10px 10px 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                            Cont&aacute;ctanos para cualquier duda {{ $mail_body['admin_eamil'] }}
                            <br><br>
                            Si recibiste este correo por error, por favor haz caso omiso y b&oacute;rralo inmediatamente.
Por favor revisa Nuestras <a target="_blank" href="http://enfadelivery.com/politicaenvios">Pol&iacute;ticas de env&iacute;o</a> para verificar que lo que est&aacute;s enviando sea permitido.
                        </div>
