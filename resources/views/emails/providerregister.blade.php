				...
				<table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="50%" style="text-align:left;">
							<a href="#" style="text-decoration:none;"><h3 style="font-size: 25px;font-family: 'Helvetica Neue', helvetica, arial, sans-serif;font-weight: bold;color: #6B6B6B;margin: 0;">¡Est&aacute;s apunto de convertirte en Enfadelivery-Transport-er!</h3></a>
						</td>
				...
				<table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
							<span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="#" style="color:#ffffff; outline:none; text-decoration:none;">Bienvenido(a) a <?php  $siteTitle = Config::get('app.website_title'); echo $siteTitle;  ?>
            <?php echo $email_data['name']; ?></a> </span>
						</td>
						<td class="resp-full-td" valign="top" style="padding:20px; text-align:center;"> Una vez que actives tu correo, podr&aacute;s entrar a tu panel de control, donde deber&aacute;s subir tus documentos para ser aprobado como Enfadelivery-Transport-er<br>Bienvenido a la familia Enfadelivery-Transport- - Urban Delivery
						</td>
					</tr>
							...
							<table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
										...
										<div style="text-align:center"><a href="http://enfadelivery.com/provider/activation/<?php echo $email_data['activation_code']; ?>" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #2ECC71;color:#fff;text-align:center;  text-decoration: none;">Haz clic para activar tu correo </a></div>
										<br>
									</td>
								</tr>
