<html>
    ...
    <body style="margin: 0px; padding: 0px; border: 0px;font-family: sans-serif;">
        ...
        <div style="margin: 0px auto;width: 90%; padding: 15px;background-color: #ff9d3d;color: #FFFFFF;">
            <!-- logo -->            
            <div>
                <div style="float: left;"><!--<img alt="logo" src="{{ asset_url() }}/image/email_logo.png" style="width: 200px;padding: 0px 0px 12px 0px;">--><img alt="logo2" src="http://enfadelivery.com/images/letra-Enfadelivery-Transport-bco2.png" style="width: 150px;padding: 0px 0px 12px 50px;"></div>
                ...
                <div style="padding: 1.5em;color: #000000;">
                    ...
                    <div style="width: 50%;float: right;">
                        ...
                        <div style="color: #999999;font-size: 14px;">
                            ...
                            <div>
                                <p style="margin: 0px;padding: 0px;float: left;">Precio por distancia</p>
                                <p style="margin: 0px;padding: 0px;float: right;color: #000000;">{{ $mail_body['dist_cost'] }}</p>
                                <h1 style="clear: both;"></h1>
                            </div>
                            <div>
                                <p style="margin: 0px;padding: 0px;float: left;">Precio por Tiempo</p>
                            ...
                            <div>
                                <p style="margin: 0px;padding: 0px;float: left;">Bono de Promoción</p>
                ...
                <div style="padding: 15px 0px 0px 0px;color: #ffffff;background-color: #ff9d3d">
                    <div style="margin: 15px 25px 15px 0;width: 50px;width: 48%;float: left; border-right: 1px solid rgba(255,255,255,.2);">
                        ...
                        <p style="float: right;margin: 5px 0 0 5px;padding: 0px;width: 81%;">
                            ...
                            <br/>
                            <span style="font-size: 12px;"><a href="{{ web_url() }}" style="color: #FFFFFF;">Cont&aacute;ctanos</a> para preguntas a cerca de tu env&iacute;o.
                                <br/>
                   ...
                   <!-- <div style="margin: 15px 0px;width: 50px;border-radius: 150px; width: 47%;float: left;">
                    ...
                    <h1 style="clear: both;"></h1>
                    <!--<p style="text-align: center; font-size: 12px;margin-top: 30px;">Para cualquier duda  {{ $mail_body['admin_eamil'] }}</p>-->
                </div>
