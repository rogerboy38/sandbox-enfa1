...
<html>
    <head>
        ...
        <title>Enfadelivery-Transport-er Aprovado</title>
            ...
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="{{ web_url() }}" style="color:#ffffff; outline:none; text-decoration:none;">Bienvenido {{ $mail_body['walker_name'] }} To <?php /* echo "App Name"; */ echo ucwords(Config::get('app.website_title')); ?></a></span>
                    </td>
                </tr>
                <!-- <tr>
                        ...
                        <table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                                        ¡Felicitaciones!
                                        <br>
                                        Has sido aprobado para ser Enfadelivery-Transport-er.

                                        Estas listo para trabajar en <strong style="font-weight: bold;"><?php /* echo "App Name"; */echo ucwords(Config::get('app.website_title')); ?></strong> 

                                        Recuerda que la calidad de nuestro servicio te permitir&aacute; tener un trabajo muy bien remunerado y ser&aacute;s parte del motor que mueve tu ciudad. Aprovecha al m&aacute;ximo la oportunidad de pertenecer a &eacute;ste gran proyecto
                                        <br>
                                        Bienvenido a la familia Enfadelivery-Transport-
                                    </div>
                                    <br>
                            ...
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                                        Para cualquier pregunta m&aacute;ndanos un correo a  socios@enfadelivery.com
                                        <br>
                                        Cordialmente, 
                                        <br>
                                        C&eacute;sar Pescador
                                        <br>
                                        Equipo Enfadelivery-Transport- Systems
                                    </div>
                                    <!--<div style="text-align:center"><a href="#" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #ff9d3d;color:#fff;text-align:center;  text-decoration: none;">Login</a></div>
