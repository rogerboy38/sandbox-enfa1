            ...
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="{{ web_url() }}" style="color:#ffffff; outline:none; text-decoration:none;">Recuperaci&oacute;n de Contrase&ntilde;a</a></span>
                    </td>
                </tr>
                <!-- <tr>
                            ...
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                                        <strong style="font-weight: bold;">¡Listo, has recuperado tu contrase&ntilde;a!</strong>
                                    </div>
                            ...
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                                        ...
                                        <br>
                                        No olvides cambiar tu contraseña una ves que inicies sesión.
                                    </div>
                                    <br>
                                    <div style="text-align:center"><a href="{{ $mail_body['login_url'] }}" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #ff9d3d;color:#fff;text-align:center;  text-decoration: none;">Entrar Ahora</a></div>
                                    <br>
                                </td>
                            </tr>
                            <tr>
...
Si tu no solicitaste la recuperación de tu contrase&ntilde;a, av&iacute;sanos inmediatamente a contacto@enfadelivery.com
Por favor revisa Nuestras <a target="_blank" href="http://enfadelivery.com/politicaenvios">Pol&iacute;ticas de env&iacute;o</a> para verificar que lo que estás enviando sea permitido.)
                                    </div>
