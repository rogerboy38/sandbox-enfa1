<html>
    ...
    <body style="margin: 0px; padding: 0px; border: 0px;font-family: sans-serif;">
        ...
        <div style="margin: 0px auto;width: 90%; padding: 15px;background-color: #ff9d3d;color: #FFFFFF;">
            <!-- logo -->            
            <div>
                <div style="float: left;"><img alt="logo" src="<?php echo asset_url(); ?><?php echo $logo; ?>" style="width: 50px;padding: 0px 0px 12px 0px;"><!--<img alt="logo" src="{{ asset_url() }}/image/e_receipt.png" style="width: 150px;padding: 0px 0px 12px 50px;">--></div>
            ...
            <div style="background-color: #FFFFFF;">
                <div style="background-color: #f3f3f3;border-bottom: 2px solid #c3c3c3;color: #000000;">
                    <p style="float: left;margin: 0px;font-size: 2em; font-weight: bold; padding: 10px 0.6em;">${{ $mail_body['request']->total }}</p>
                    <p style="color: #999999;float: right;margin: 0px;font-size: 16px; font-weight: normal; padding: 18px 0.6em 0px 0px;">Gracias por usar <?= Config::get('app.website_title') ?>,{{ $mail_body['walker']->first_name }} {{ $mail_body['walker']->last_name }}</p>
                    <div style="clear: both;"></div>
                </div>
                <div style="padding: 1.5em;color: #000000;">
                    <div style="width:45%; background-color: #f3f3f3;border: 2px solid #c3c3c3;border-radius: 5px;(max-device-width: 600px){width: 260px;}float: left;">
                        ...
                        <div style="margin: 15px 0px;padding: 0px;text-align: center;font-size: 14px;">
                            <div style="float: left;width: 33.32%;">
                                <p style="color: #999999;margin: 0px;padding: 0px;text-transform: uppercase;font-size: 10px;">Enfadelivery-Transport-er</p>
                            ...
                            <div style="float: left;width: 33.32%;">
                                <p style="color: #999999;margin: 0px;padding: 0px;text-transform: uppercase;font-size: 10px;">TIEMPO QUE TE AHORRASTE</p>
                    ...
                    <div style="width: 50%;(max-device-width: 600px){width: 260px;}float: left;">
                        <div>
                            <div style="width: 30%;float: left;border-bottom: 1px solid #c3c3c3;padding-top: 8px;"></div>
                            <div style="width: 40%;float: left;text-transform: uppercase;text-align: center;font-size: 12px;">Desglose</div>
                            <div style="width: 30%;float: left;border-bottom: 1px solid #c3c3c3;padding-top: 8px;"></div>
                            <h1 style="clear: both;"></h1>
                        </div>
                        <div style="color: #999999;font-size: 14px;">
                            <div>
                                <p style="margin: 0px;padding: 0px;float: left;">Tarifa Base</p>
                                <p style="margin: 0px;padding: 0px;float: right;color: #000000;">{{ $mail_body['base_price']}}</p>
                                <h1 style="clear: both;"></h1>
                            </div>
                           
                            <div>
                                <p style="margin: 0px;padding: 0px;float: left;">Bono de Referido</p>
                                <p style="margin: 0px;padding: 0px;float: right;color: #000000;">{{  $mail_body['ref_bonus'] }}</p>
                                <h1 style="clear: both;"></h1>
                            </div>
                            <div>
                                <p style="margin: 0px;padding: 0px;float: left;">Bono de Promoci&oacute;n</p>
                            ...
                            <div style="color: #000000;font-weight: bold;">
                                ...
                                <p style="margin: 0px;padding: 0px;float: right;">${{ $mail_body['request']->card_payment }}</p>
                                <h1 style="clear: both;"></h1>
                            </div>
                            <div >
                            ...
                            <div>
                                <p style="margin: 0px;padding: 0px;float: left;text-transform: uppercase;font-size: 8px;">Cargo</p>
                                <p style="margin: 0px;padding: 0px;float: right;color: #000000;font-weight: bold;font-size: 16px;">${{ $mail_body['request']->card_payment }}</p>
                ...
                <div style="margin: 0px 0px 0px 1.5em;color: #000000;">
                    <div style="margin: 15px 0px;width: 50px;border-radius: 150px; width: 90%;">
                        ...
                        <p style="float: left;margin: 5px 0 0 5px;padding: 0px;">
                            Tu Enfadelivery-Transport-er fue {{ $mail_body['walker']->first_name }} {{ $mail_body['walker']->last_name }}

                            <br/>
                            Empresa: <?php /* echo "App Name"; */echo ucwords(Config::get('app.website_title')); ?>.
                        </p>
                        <h1 style="clear: both;"></h1>
                    </div>
                </div>
                <div style="padding: 15px 0px 0px 0px;color: #ffffff;background-color: #ff9d3d">
                    <div style="margin: 15px 25px 15px 0;width: 50px;width: 48%;float: left; border-right: 1px solid rgba(255,255,255,.2);">
                        ...
                        <p style="float: right;margin: 5px 0 0 5px;padding: 0px;width: 81%;">
                            <span style="color: #000000;font-size: 12px;font-weight: bold;"><?= Config::get('app.website_title') ?> Soporte</span>
                            <br/>
                            <span style="font-size: 12px;"><a href="{{ web_url() }}" style="color: #FFFFFF;">Cont&aacute;ctanos</a> para preguntas a cerca de tu env&iacute;o. <?php echo ucwords(Config::get('app.generic_keywords.Trip')); ?>.
                                <br/>
                                Dejaste algo &aacute;tras? <a href="{{ web_url() }}" style="color: #FFFFFF;">Rastrealo.</a></span>
                        </p>
                        <h1 style="clear: both;"></h1>
                    </div>
                    <!--<div style="margin: 15px 0px;width: 50px;border-radius: 150px; width: 47%;float: left;">
                        ...
                        <p style="float: right;margin: 5px 0 0 5px;padding: 0px;width: 81%; font-size: 12px;font-weight: bold;">
                            <!--Give <?php echo Config::get('app.generic_keywords.Currency'); ?>30, Get <?php echo Config::get('app.currency_symb'); ?>30
                            >&nbsp;&nbsp;&nbsp;
                        </p>
                    ...
                    <h1 style="clear: both;"></h1>
                    <p style="text-align: center; font-size: 12px;margin-top: 30px;">For any questions {{ $mail_body['admin_eamil'] }}</p>
                </div>
