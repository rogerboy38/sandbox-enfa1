            ...
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="{{ web_url() }}" style="color:#ffffff; outline:none; text-decoration:none;">Bienvenido(a) a  <?php /* echo "App Name"; */ echo ucwords(Config::get('app.website_title')) ?>, {{ $mail_body['name'] }}</a> </span>
                    </td>
                </tr>
                <!-- <tr>
                        ...
                        <table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    <div style="padding: 10px;font-size:22px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;color: #ff9d3d;text-align:center;">Gracias por registrarte! Estamos emocionados de que te nos hayas unido como Enfadelivery-Transport-er.
                                    </div>
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">Una vez que actives tu correo, podr&aacute;s entrar a tu panel de control, donde deber&aacute;s subir tus documentos para ser aprobado como Enfadelivery-Transport-er<br>Bienvenido a la familia Enfadelivery-Transport- - Urban Delivery
 </div>
                                    
                                    <br><br>
                                    <!--<div style="text-align:center"><a href="{{ web_url() }}" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #ff9d3d;color:#fff;text-align:center;  text-decoration: none;">Ve al sitio </a></div>
                                    --><br>
                            ...
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                                        Para cualquier duda {{ $mail_body['admin_eamil'] }}
                                    </div>
