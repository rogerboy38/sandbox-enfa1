...
<div class="box box-primary">
    ...
    {{  Form::hidden('url',URL::previous())  }}
      <form method="post" id="basic" action="{{ URL::Route('AdminProviderTypeUpdate') }}"  enctype="multipart/form-data">
        ...
        <div class="form-group col-md-6 col-sm-6">
            <label>Base Price (in MXN)</label> <span id="no_amount_error1" style="display: none"> </span>
        ...
        <div class="form-group col-md-6 col-sm-6">
            <label>Price Per Unit Distance (in MXN)</label> <span id="no_amount_error2" style="display: none"> </span>
        ...
        <div class="form-group col-md-6 col-sm-6">
            <label>Price Per Unit Time (in MXN)</label> <span id="no_amount_error3" style="display: none"> </span>
