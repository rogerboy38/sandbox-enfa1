...
<div class="box box-primary">
    <div class="box-header">
        <h3 class="box-title">Edit Promo Code 23</h3>
        <h3 class="box-title">{{csrf_field()}}</h3>
    </div><!-- /.box-header -->
    <!-- form start -->
    {{  Form::hidden('url',URL::previous())  }}
    <form role="form" id="form" method="post" action="{{ URL::Route('AdminPromoCodeUpdate') }}"  enctype="multipart/form-data" name='AdminPromoCodeUpdate'>
        {{csrf_field()}}
