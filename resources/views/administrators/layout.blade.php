...
<html>
    ...
    <head>
        ...
        foreach ($theme as $themes) {
            ...
            $favicon = '../resources/assets/images/' .  $themes->favicon;
            $logo = '../resources/assets/images/' . $themes->logo;
        }
        if ($logo == '/images/') {
            $logo = '/images/logo.png';
        }
        ...
        <link href="{{asset('/admins/bootstrap.min.css')}}" rel=="stylesheet" type="text/css" />
        <!--<link href="http://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" />-->
        <link href="{{asset('/admins/font-awesome.min.css')}}" rel=="stylesheet" type="text/css" />
        <!-- Ionicons -->
        <!--<link href="http://code.ionicframework.com/ionicons/1.5.2/css/ionicons.min.css" rel="stylesheet" type="text/css" />-->
        <link href="{{asset('/admins/ionicons.min.css')}}" rel=="stylesheet" type="text/css" />
        ...
        <script src="{{asset('/admins/js/validator/jquery.validate.js')}}"></script>
    ...
    <body class="skin-blue" >
        ...
        <header class="header">
            <a  class="logo" href="{{ URL::Route('AdminMapview') }}" >
                ...
                <img src="{{asset($logo)}}"  width="40" height="40"><?php
