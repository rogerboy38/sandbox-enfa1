...
<div class="container-fluid login">
    <div class="row h-60">
        <div class="col-sm-12 col-md-5 d-flex flex-column align-items-center justify-content-end -left">
            ...
            <strong>Iniciar Sesión Administrador</strong>
            <form method="POST" action="{{ route('AdminVerify') }}" class="sign -in">
        ...
        <div class="d-none col-md-7 d-md-flex flex-column align-items-center justify-content-center -right">
            <div class="intro">
                <p>AdminUsers</p>
                <p>Acceso exclusivo de personal y socios comerciales de Enfa Delivery.</p>
            </div>
        </div>
    </div>
</div>
