...
Route::post('userRegister','LandingController@register');
...
Route::post('/user/solicitar_Enfadelivery-Transport-er', 'DogController@userRequestTrip2');
...
//Route::post('admin/verify', array('as' => 'AdminVerify', 'uses' => 'AdminController@verify', 'before' => 'csrf', function()
//{
  //  return response('hi');
    //return 'You gave a valid CSRF token!';
//}));
Route::get('/admin/login', array('as' => 'AdminLogin', 'uses' => 'AdminController@ShowLoginAdmin'));
Route::get('/provider/login', array('as' => 'ProviderLogin', 'uses' => 'WebProviderController@ShowLoginProvider'));
Route::get('/walker/login', array('as' => 'WalkerLogin', 'uses' => 'WalkerController@ShowLoginWalker'));
Route::get('/owner/login', array('as' => 'OwnerLogin', 'uses' => 'OwnerController@ShowLoginOwner'));


Route::get('AllUsersLogin', array('as'=> 'AllUsersLogin', 'uses' => 'Auth\LoginController@ShowAllUserAccess'));
Route::post('AllUsersLogin', array('as'=> 'AllUsersLogin', 'uses' => 'Auth\LoginController@ShowAllUserAccess'));

Route::post('/admin/verify', array('as' => 'AdminVerify', 'uses' => 'AdminController@adminVerify'));
...
Route::get('/owner/logout', array('as' => 'OwnerLogout', 'uses' => 'OwnerController@logout'));
...
Route::get('/admin/promo_code/update', function () {
  return redirect('/admin/promo_code');
});
Route::post('/admin/promo_code/update', array('as' => 'AdminPromoCodeUpdate', 'uses' => 'AdminController@update_promo_code'));
...
//Route::get('ProviderLogin', array('as' => 'ProviderLogin', 'uses' =>'LandingController@providerLogin'));
...
Route::get('/user/paymentsFB', array('as' => 'userPaymentFB', 'uses' => 'WebUserController@userPaymentsFB'));
...
Route::get('/socios/registro', array(
    'as' => 'ProviderSignup',
